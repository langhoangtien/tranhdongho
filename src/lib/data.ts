export const COUNTRIES = [
  ...
  },
  {
    ...
    code: "VN",
    states: [
      { name: "An Giang", code: "An Giang" },
      { name: "Bà Rịa - Vũng Tàu", code: "Bà Rịa - Vũng Tàu" },
      { name: "Bạc Liêu", code: "Bạc Liêu" },
      { name: "Bắc Giang", code: "Bắc Giang" },
      { name: "Bắc Kạn", code: "Bắc Kạn" },
      { name: "Bắc Ninh", code: "Bắc Ninh" },
      { name: "Bến Tre", code: "Bến Tre" },
      { name: "Bình Dương", code: "Bình Dương" },
      { name: "Bình Định", code: "Bình Định" },
      { name: "Bình Phước", code: "Bình Phước" },
      { name: "Bình Thuận", code: "Bình Thuận" },
      { name: "Cà Mau", code: "Cà Mau" },
      { name: "Cao Bằng", code: "Cao Bằng" },
      { name: "Cần Thơ", code: "Cần Thơ" },
      { name: "Đà Nẵng", code: "Đà Nẵng" },
      { name: "Đắk Lắk", code: "Đắk Lắk" },
      { name: "Đắk Nông", code: "Đắk Nông" },
      { name: "Điện Biên", code: "Điện Biên" },
      { name: "Đồng Nai", code: "Đồng Nai" },
      { name: "Đồng Tháp", code: "Đồng Tháp" },
      { name: "Gia Lai", code: "Gia Lai" },
      { name: "Hà Giang", code: "Hà Giang" },
      { name: "Hà Nam", code: "Hà Nam" },
      { name: "Hà Nội", code: "Hà Nội" },
      { name: "Hà Tĩnh", code: "Hà Tĩnh" },
      { name: "Hải Dương", code: "Hải Dương" },
      { name: "Hải Phòng", code: "Hải Phòng" },
      { name: "Hậu Giang", code: "Hậu Giang" },
      { name: "Hòa Bình", code: "Hòa Bình" },
      { name: "Hưng Yên", code: "Hưng Yên" },
      { name: "Khánh Hòa", code: "Khánh Hòa" },
      { name: "Kiên Giang", code: "Kiên Giang" },
      { name: "Kon Tum", code: "Kon Tum" },
      { name: "Lai Châu", code: "Lai Châu" },
      { name: "Lạng Sơn", code: "Lạng Sơn" },
      { name: "Lào Cai", code: "Lào Cai" },
      { name: "Lâm Đồng", code: "Lâm Đồng" },
      { name: "Long An", code: "Long An" },
      { name: "Nam Định", code: "Nam Định" },
      { name: "Nghệ An", code: "Nghệ An" },
      { name: "Ninh Bình", code: "Ninh Bình" },
      { name: "Ninh Thuận", code: "Ninh Thuận" },
      { name: "Phú Thọ", code: "Phú Thọ" },
      { name: "Phú Yên", code: "Phú Yên" },
      { name: "Quảng Bình", code: "Quảng Bình" },
      { name: "Quảng Nam", code: "Quảng Nam" },
      { name: "Quảng Ngãi", code: "Quảng Ngãi" },
      { name: "Quảng Ninh", code: "Quảng Ninh" },
      { name: "Quảng Trị", code: "Quảng Trị" },
      { name: "Sóc Trăng", code: "Sóc Trăng" },
      { name: "Sơn La", code: "Sơn La" },
      { name: "Tây Ninh", code: "Tây Ninh" },
      { name: "Thái Bình", code: "Thái Bình" },
      { name: "Thái Nguyên", code: "Thái Nguyên" },
      { name: "Thanh Hóa", code: "Thanh Hóa" },
      { name: "Thừa Thiên Huế", code: "Thừa Thiên Huế" },
      { name: "Tiền Giang", code: "Tiền Giang" },
      { name: "TP. Hồ Chí Minh", code: "TP. Hồ Chí Minh" },
      { name: "Trà Vinh", code: "Trà Vinh" },
      { name: "Tuyên Quang", code: "Tuyên Quang" },
      { name: "Vĩnh Long", code: "Vĩnh Long" },
      { name: "Vĩnh Phúc", code: "Vĩnh Phúc" },
      { name: "Yên Bái", code: "Yên Bái" },
    ],
  },
];
