...
export type BackToTopProps = HTMLProps<HTMLSpanElement> & {
  value?: number;
};

export function BackToTop({ value = 90, ...other }: BackToTopProps) {
  ...
  return (
    <span
      ...
      //   ...sx,
      // }}
      className={`fixed bottom-4 right-4 z-50 h-12 w-12 transform transition-transform ${show ? 'scale-100' : 'scale-0'}`}
      {...other}
    >
      <svg>
